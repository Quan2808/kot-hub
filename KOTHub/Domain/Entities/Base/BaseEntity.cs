...
public abstract class BaseEntity<TKey> where TKey : IEquatable<TKey>
{
    ...
    public TKey Id { get; set; } = default!; // Suppress CS8618 as Id is set by the database
    ...
    /// </summary>
    [MaxLength(100)]
    public string? CreatedBy { get; set; } // Nullable to allow optional creator

    /// <summary>
    /// Gets or sets the user who last updated the entity.
    /// </summary>
    [MaxLength(100)]
    public string? UpdatedBy { get; set; } // Nullable to allow optional updater
    ...
    /// </summary>
    /// <param name="deletedBy">The user who marked the entity as deleted. Can be null if unknown.</param>
    ...
    /// </summary>
    /// <param name="updatedBy">The user who updated the entity. Can be null if unknown.</param>
    ...
    {
        return Id?.GetHashCode() ?? 0; // Safe null handling for Id
    }
}